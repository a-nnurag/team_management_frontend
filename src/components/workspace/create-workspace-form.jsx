...
export default function CreateWorkspaceForm({ onClose }) {
  ...
  return (
    <main className="w-full flex flex-row min-h-[590px] h-auto max-w-full">
      <div className="h-full px-10 py-10 flex-1">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <Button
              disabled={isPending}
              className="w-full h-[40px] text-black font-semibold"
              type="submit"
            >
      ...
      <div
        className="relative flex-1 shrink-0 hidden bg-muted md:block h-full
    bg-[url('/images/workspace.jpg')] bg-cover bg-center"
      />
    </main>
  );
}
